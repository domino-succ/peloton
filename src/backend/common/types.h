...
enum TxnType {
  ...
  // For TATP
  TXN_TYPE_GET_SUBSCRIBER_DATA = 8,
  TXN_TYPE_GET_ACCESS_DATA = 9,
  TXN_TYPE_GET_NEW_DESTINATION = 10,
  TXN_TYPE_UPDATE_LOCATION = 11,
  TXN_TYPE_UPDATE_SUBSCRIBER_DATA = 12,
  TXN_TYPE_INSERT_CALL_FORWARDING = 13,
  TXN_TYPE_DELETE_CALL_FORWARDING = 14
};
