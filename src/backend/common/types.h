...
enum TxnType {
  ...
  TXN_TYPE_TRANSACT_SAVING = 8,
  TXN_TYPE_WRITE_CHECK = 9,

  // For TATP
  TXN_TYPE_GET_SUBSCRIBER_DATA = 10,
  TXN_TYPE_GET_ACCESS_DATA = 11,
  TXN_TYPE_GET_NEW_DESTINATION = 12,
  TXN_TYPE_UPDATE_LOCATION = 13,
  TXN_TYPE_UPDATE_SUBSCRIBER_DATA = 14,
  TXN_TYPE_INSERT_CALL_FORWARDING = 15,
  TXN_TYPE_DELETE_CALL_FORWARDING = 16
};
