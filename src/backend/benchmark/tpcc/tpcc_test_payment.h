...
class TestPayment : public concurrency::TransactionQuery {
 public:
  TestPayment()
  ...
  virtual void Cleanup() {
    ...
    // Note: context is set in RunTestPayment, and it is unique_prt
    // delete context_;
    // context_ = nullptr;
  ...
  virtual const std::vector<Value>& GetCompareKeys() const {
    return district_index_scan_executor_->GetValues();
  }
