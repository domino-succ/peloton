...
/*
 * This function new a Test, so remember to delete it
 */
Test *GenerateTest() {
...
*/
  ...
  test->stock_update_index_scan_executor_ = stock_update_index_scan_executor;

  test->stock_update_executor_ = stock_update_executor;
...
bool Test::Run() {
  /*
     ...
     "createTest": "INSERT INTO NEW_ORDER (NO_O_ID, NO_D_ID, NO_W_ID) VALUES
     (?, ?, ?)", # o_id, d_id, w_id
